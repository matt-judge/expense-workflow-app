<div class="max-w-2xl mx-auto p-4 bg-white shadow-md rounded-lg">
    ...
    <div class="mt-4">
        <button wire:click="export" class="px-4 py-2 bg-indigo-600 rounded-md shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">Download Report</button>
    </div>
</div>